...
contract AWMMappingToken is StopTrade, SafeMath {
    ...
    function mintToken(address target, uint256 mintedAmount) onlyOwner stoppable public {
        require(!frozenAccount[target]);            // Check if recipient is frozen
